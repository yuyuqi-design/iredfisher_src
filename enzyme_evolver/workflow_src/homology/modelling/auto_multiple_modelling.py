...
def auto_multiple_modelling(seqcode: str, base_folder: str, data_folder: str, db_folder='enzyme_evolver/database')\
        -> pd.DataFrame:
    """
    ...
    @param seqcode: sequence code. e.g. test
    ...
    try:
        ...
        os.mkdir(f"{seq_folder}")
    # copy the sequence file into the seq_folder
    ...
    df_best_template = homology.auto_multiple_modelling(seqcode=seqcode, db=db_folder)
